...
bounded reinforcement learning for decision rehearsal before any real-world action.

Created and maintained by Yash Sharma (https://www.linkedin.com/in/yashsharmaa/).
Licensed under the MIT License.
"""

__version__ = "0.1.0"
__author__ = "Yash Sharma"
